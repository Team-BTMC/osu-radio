...
const InstallationCard: Component<InstallationCardProps> = (props) => {
  return (
    <div
      class={`flex h-[72px] w-full select-none items-center rounded-xl border border-white/5 p-3 cursor-pointer ${props.selectedDir() === props.directory ? "bg-surface" : "bg-regular-material"}`}
